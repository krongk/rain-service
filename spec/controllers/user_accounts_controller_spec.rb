...
describe UserAccountsController do
  ...
  describe "GET index" do
    it "assigns all user_accounts as @user_accounts" do
      ...
      assigns(:user_accounts).should eq([user_account])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_account as @user_account" do
        ...
        post :create, {:user_account => { "user" => "invalid value" }}, valid_session
        assigns(:user_account).should be_a_new(UserAccount)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_account" do
        ...
        UserAccount.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => user_account.to_param, :user_account => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_account as @user_account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserAccount.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_account.to_param, :user_account => { "user" => "invalid value" }}, valid_session
        assigns(:user_account).should eq(user_account)
      end
